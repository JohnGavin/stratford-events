...
def fetch_tennis_events():
    ...
    # 3. Major Events (Static placeholders based on search - could be expired but good for info)
    # e.g. FIH Hockey Pro League (June) - skipped as user asked for Tennis, but sometimes they share.
